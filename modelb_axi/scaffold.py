...
# hermes; DN §4.4), stripping it entirely from the primary harness. The
...
def _render_instance_toml(instance: dict) -> str:
    """One neutral-schema instance as TOML (stdlib has no writer; values
    here are only bare-word strings + ints, so plain quoting suffices)."""
    lines = [
