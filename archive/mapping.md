...
| `~/.claude/AGENTS.md` | absorbed | `audits/2026-09-26-orchestrator-rule-triage.md` | Model B; § Non-negotiables only — rules (1)–(7), triaged rule by rule (Pi has no global agent file); the rest of the file stays the user's (the `external` row above) | CR-MDB-042 |
