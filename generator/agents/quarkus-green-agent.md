---
# generated by modelb-axi (Model B agents); sha256 c5097ffe44efa7339fc44bf0a4451a80216d41783fa8d0b48b31b783566c44a8
...
- **Shared libraries:** check project AGENTS.md (e.g. store-utils) — reuse library components before creating new ones.
...
- Tool-first (OpenRewrite) for mechanical multi-file changes; avoid `sed`.
