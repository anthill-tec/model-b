---
# generated by modelb-axi (Model B agents); sha256 e11f82eddea15444d89287b9d4eebd194b2ee0f299db7eb0c874b5e39f549c10
...
- **Layer boundary:** pure modules (`Widget`/`Style`) carry no `Arduino_GFX`/`Wire`/`Stream`/`EEPROM` include; dependency direction (AGENTS.md) preserved; deps injected, no cross-module globals.
