---
# generated by modelb-axi (Model B agents); sha256 762c38cb515bcff9398afa3ee3e0113afbb8a3ccbd673a2cc1ea93644b085ce9
name: rust-fix-agent
...
- **Mechanical multi-file changes:** `cargo fix` > `ast-grep` > `cargo clippy --fix` > manual; `edit` for a trivial known old→new; no `sed` on `.rs`.
